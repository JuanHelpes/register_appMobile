...
export default function TelaVisualizarEvento() {
  const router = useRouter();
  const { idEvento, nomeEvento } = useLocalSearchParams();
  // const { idEvento } = "route.params";
  // const { nomeEvento } = "route.params";
  const [search, setSearch] = useState("");
  const [atividades, setAtividades] = useState([
    { ati_id: 1, nome: "Atividade 1" },
    { ati_id: 2, nome: "Atividade 2" },
  ]);
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.lista}>
        {atividades.map((atividade) => (
          <View style={styles.item} key={atividade.ati_id}>
            <View>
            ...
            <View style={styles.icons}>
              ...
              <Ionicons
                ...
                color="#fff"
                size={30}
                onPress={() => confirmacao(atividade.ati_id)}
              />
              <Ionicons
                name="people"
                color="#fff"
